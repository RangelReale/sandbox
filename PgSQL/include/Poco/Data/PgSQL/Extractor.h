...
// Extractor.h
//
// $Id: //poco/1.4/Data/PgSQL/include/Poco/Data/PgSQL/Extractor.h#1 $
//
// Library: Data
// Package: PgSQL
// Module:  Extractor
...
#ifndef Data_PgSQL_Extractor_INCLUDED
#define Data_PgSQL_Extractor_INCLUDED
...
class PgSQL_API Extractor: public Poco::Data::AbstractExtractor
	/// Extracts and converts data values from the result row returned by PgSQL.
...
private:
	...
	bool realExtractFixed(std::size_t pos, int type, void* buffer, std::size_t length = 0);
...
#endif // Data_PgSQL_Extractor_INCLUDED
