...
// Binder.h
//
// $Id: //poco/1.4/Data/PgSQL/include/Poco/Data/PgSQL/Binder.h#1 $
//
// Library: Data
// Package: PgSQL
// Module:  Binder
...
#ifndef Data_PgSQL_Binder_INCLUDED
#define Data_PgSQL_Binder_INCLUDED
...
class PgSQL_API Binder: public Poco::Data::AbstractBinder
...
private:
	...
	void realBind(std::size_t pos, int type, const void* buffer, int length);
		/// Common bind implementation

private:

	std::vector<PgSQL_BIND> _bindArray;
};
...
#endif // Data_PgSQL_Binder_INCLUDED
